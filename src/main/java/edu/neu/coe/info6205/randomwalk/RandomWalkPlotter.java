 ...
 * @author pallaksingh
 * 
 * This class is used to plot the x and y values produced during the random walk experiment conducted 
 * in RandomWalk.java
 *
 */
public class RandomWalkPlotter extends JFrame {
	 ...
	 */
	public RandomWalkPlotter(XYSeries series1) {
		initUI(series1);
	}
	 ...
	 */
	public RandomWalkPlotter(XYSeries series1, XYSeries series2) {
	 ...
	 */
	public RandomWalkPlotter(XYSeries series1, XYSeries series2, XYSeries series3) {
	...
	private JFreeChart createChart(XYDataset dataset, int length) {
        ...
        JFreeChart chart = ChartFactory.createXYLineChart(
                "Distance over Steps in Random Walk",
                "Steps",
                "Distance",
                dataset,
        ...
        chart.setTitle(new TextTitle("Random Walk Experiment",
